...
public class GraphImpl<T> {
   ...
   */
  public void depthFirstSearch(Vertex<T> v, final DFSVisitor<T> visitor) {
    VisitorEX<T, RuntimeException> wrapper = new VisitorEX<T, RuntimeException>() {
      public void visit(GraphImpl<T> g, Vertex<T> v) throws RuntimeException {
        if (visitor != null)
          visitor.visit(g, v);
      }
    };
   ...
   */
  public void breadthFirstSearch(Vertex<T> v, final DFSVisitor<T> visitor) {
    VisitorEX<T, RuntimeException> wrapper = new VisitorEX<T, RuntimeException>() {
      public void visit(GraphImpl<T> g, Vertex<T> v) throws RuntimeException {
        if (visitor != null)
          visitor.visit(g, v);
